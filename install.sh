...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/alacritty-nautilus.py https://raw.githubusercontent.com/fernandesafp/Alacritty-Nautilus/master/alacritty-nautilus.py
