...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/alacritty-nautilus.py https://raw.githubusercontent.com/Grafcube/Alacritty-Nautilus/master/alacritty-nautilus.py
